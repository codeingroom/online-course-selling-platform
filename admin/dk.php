...
<center>    <h2>Add Course</h2>
    <form action="dk.php" method="post"  enctype="multipart/form-data">
        ...
        <div style="margin-top:1rem;">
            ...
            <input type="text" id="course_title" name="course_title" placeholder="Course Name" required>
        </div>
        <div style="margin-top:1rem;">
            <label for="course_description">Short Description:</label><br>
            <textarea id="course_description" name="course_description" rows="4" cols="50" placeholder="Enter Description.."required></textarea>
        </div>
        <div style="margin-top:1rem;">
            <label for="course_price">Price:</label><br>
            <input type="number" id="course_price" name="course_price" placeholder="Enter Price" required>
        </div>
		
		<div style="margin-top:1rem;">
            <label for="course_price">Buy Link:</label><br>
            <input type="text" id="course_price" name="buy_link" placeholder="Enter Buying Link" required>
        </div>
        <div>
